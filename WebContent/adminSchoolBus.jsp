...
<body>
	...
	<h3>버스 마스터</h3><hr>
		<form>
			<input type="button"  value ="시내 셔틀 위치" onclick = "location.href='adminBusLocation.jsp'"> <br>
			<input type="button"  value ="시내/시외 셔틀 시간표" onclick = "location.href='adminBusSchedule.jsp'"> <br>
