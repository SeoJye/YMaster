...
<body>
	...
	<h2>맛집 마스터</h2><hr>
		...
		<br>
		<input type="button" style="background-color:#ccffcc; width:30%; height:20pt;" value="새글 등록" onclick="location.href='insertRestaurant.jsp'"/>
		<input type="button" style="background-color:#ccffcc; width:30%; height:20pt;" value="메인으로" onclick="location.href='adminMain.jsp'"/>
	</div>
</body>
</html>