...
<div align="right">
	...
	<h2>택시 마스터</h2><hr>
		...
		<hr>
		<form action="taxiInsertProc.jsp" method="post">
		<table border="1" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<select name ="timeMinute"> <option value="00">00</option><option value="01">01</option></select>분</td>
			</tr>
			<tr>
				<td>내용</td>
